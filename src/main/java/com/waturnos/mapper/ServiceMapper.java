...
public interface ServiceMapper {
    ...
    @Named("providerFromId") public static Provider mapProv(Long id){ if(id==null) return null; Provider p=new Provider(); p.setId(id); return p; }
    @Named("locationFromId") public static Location mapLoc(Long id){ if(id==null) return null; Location l=new Location(); l.setId(id); return l; }
}
