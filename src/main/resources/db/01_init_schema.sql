...
CREATE TABLE booking (
    ...
    status VARCHAR(50) NOT NULL CHECK (status IN ('FREE','PARTIALLY_RESERVED','RESERVED','NO_SHOW','COMPLETED','CANCELLED', 'FREE_AFTER_CANCEL', 'RESERVED_AFTER_CANCEL', 'COMPLETED_AFTER_CANCEL', 'CANCELED_BY_PROVIDER', 'LOCK_BY_EXCLUSION', 'DISABLE')),
    notes TEXT,
